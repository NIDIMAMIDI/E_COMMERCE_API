...
export const authValidator = async (req, res, next)=>{
    ...
    password: Joi.string().regex(strongPasswordRegex).required().messages({
        ...
        "string.pattern.base": "Password must at least one upper case alphabet, one lower case alphabet, one digit, one special character, and between 8 and 15 characters long",
